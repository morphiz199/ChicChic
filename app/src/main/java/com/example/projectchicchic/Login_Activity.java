        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (mFirebaseeUser != null){
                    ...
                    Intent i = new Intent(Login_Activity.this,HomeUserActivity.class);
                    startActivity(i);
...
//        });
        Signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent inSignUp = new Intent( Login_Activity.this, register_user.class);
    ...
    private void checkUserAccessLevel(String uid) {
        DocumentReference df = mFirebaseFirestore.collection("User").document(uid);
